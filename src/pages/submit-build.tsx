      ...
      <section className="flex h-full flex-col items-center justify-center gap-8 text-black dark:text-white">
        ...
        >
          ...
          <Label htmlFor="build-description">
            Description
            <textarea
              className="dark:placeholder-gray-40 mx-auto mt-1 block w-auto max-w-full resize rounded-lg border p-2.5  text-sm font-normal text-black dark:border-gray-600 dark:bg-gray-700 dark:text-white md:min-h-[5rem] md:w-2/5 md:min-w-[15rem]"
              name="description"
          ...
          <Label htmlFor="build-order" className="w-3/4">
            Build
            <textarea
              className="dark:placeholder-gray-40 mx-auto mt-1 block h-24 w-4/5 max-w-full resize  rounded-lg border p-2.5 text-sm font-normal text-black dark:border-gray-600 dark:bg-gray-700 dark:text-white md:min-h-[10rem] md:min-w-[15rem]"
              name="build-order"
              id="build-order"
